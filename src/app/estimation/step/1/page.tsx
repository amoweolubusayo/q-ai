        ...
        <main className="py-10 lg:pl-72">
          <div className="px-4 sm:px-6 lg:px-8">
            ...
            <div className="sm:col-span-3 mt-2">
              ...
              <p className="text-sm leading-6 text-gray-600">What Inspection Services Do You Need? * </p>
              ...
              <div className="mt-2">
                ...
                >
                  ...
                  <option value="sprinkler">Sprinkler system inspection</option>
                  ...
                  <option value="fire_hydrant">Fire Hydrant Inspection</option>
            ...
            <div className="sm:col-span-4 mt-2">
              ...
              <p className="text-sm leading-6 text-gray-600">Regular maintenance can prolong equipment life and ensure optimal functionality. Q-AI uses this to schedule future inspections efficiently.
* </p>
