...
import { FaXing, FaBars, FaBoxes } from "react-icons/fa";
            ...
            <div className="mt-10">
              ...
              <div className="sm:col-span-3 mt-2">
                ...
                <p className="text-sm leading-6 text-gray-600">
                  What Inspection Services Do You Need? *{" "}
                </p>
              ...
              <div className="sm:col-span-4 mt-2">
                ...
                <p className="text-sm leading-6 text-gray-600">
                  Regular maintenance can prolong equipment life and ensure
                  optimal functionality. Q-AI uses this to schedule future
